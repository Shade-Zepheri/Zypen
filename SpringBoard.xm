...
- (_Bool)clickedMenuButton {
  if ([ZYSettings.sharedSettings homeButtonClosesReachability] && [[%c(SBMainWorkspace) sharedInstance] isUsingReachApp] && ((SBReachabilityManager*)[%c(SBReachabilityManager) sharedInstance]).reachabilityModeActive) {
