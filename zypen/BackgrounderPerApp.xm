...
BOOL reload = NO;
void ZY_BGAppsControllerNeedsToReload()
{
    reload = YES;
}

@interface ZYBGPerAppController : PSViewController <UITableViewDelegate>
{
...
@implementation ZYBGPerAppController
...
-(void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath
{
	...
	ZYBGPerAppDetailsController *controller = [[ZYBGPerAppDetailsController alloc] initWithAppName:cell.textLabel.text identifier:[_dataSource displayIdentifierForIndexPath:indexPath]];
