...
extern void ZY_BGAppsControllerNeedsToReload();

@implementation ZYBGPerAppDetailsController
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier*)specifier {
    ...
    if ([[specifier propertyForKey:@"key"] isEqualToString:@"UIApplicationExitsOnSuspend"]) {
        ...
        if (!success) {
            ...
            [daemonDict writeToFile:@"/var/mobile/Library/.zypen.uiappexitsonsuspend.wantstochangerootapp" atomically:YES];
        }
    ...
    CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("com.shade.zypen/ReloadPrefs"), nil, nil, YES);
    ZY_BGAppsControllerNeedsToReload();
