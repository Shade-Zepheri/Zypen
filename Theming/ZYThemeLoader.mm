...
#define COLOR(name) ([ZYThemeLoader tryGetColorFromThemeImageName:name] ?: [UIColor ZY_colorWithHexString:dict[name]])
...
+ (ZYTheme*)themeFromDictionary:(NSDictionary*)dict {
	...
	ret.windowedMultaskingBarTitleTextAlignment = [ZYThemeLoader getTextAlignment:dict[@"windowedMultaskingBarTitleTextAlignment"]];
	...
	ret.swipeOverDetachImageColor = COLOR(@"swipeOverDetachImageColor") ?: [UIColor ZY_colorWithHexString:@"737273"];
